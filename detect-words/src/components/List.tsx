                        ...
                        <div key={char}>
                            ...
                            >
                                <div className="flex items-center justify-between">
                                    <span className="text-[14px] font-medium text-[#102c86] lowercase">{char}</span>
                            ...
                            {accordion[char] && (
                                <div className="pl-2 pt-1 pb-3 flex flex-wrap gap-2">
                                    {groupedWords[char].map((w) => (
                                        <div
                                            key={w.word}
                                            className="flex gap-2 items-center flex-wrap group relative"
                                        >
                                            <span className="px-3 py-1 rounded-[6px] bg-white border border-[#c3d6f7] text-[14px] font-semibold shadow-sm relative">
                                                {w.word}
                                                <button
                                            ...
                                            {w.variants.map((v, idx) => (
                                                <span
                                                    key={idx}
                                                    className="px-3 py-1 rounded-[6px] bg-[#e0ecfb] border border-[#c3d6f7] text-[13px] font-normal"
                                                >
                                                    {v}
                                                </span>
                                            ))}
